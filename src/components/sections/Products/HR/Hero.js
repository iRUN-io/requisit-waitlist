        ...
        <div className="row align-items-center pt-5">
          <div className="col-lg-6 col-md-6">
            <div className="title-heading center-mobile">
              ...
              We have developed a strategic approach to effectively and efficiently manage employees in your company or organization such that you can help your business gain a competitive advantage.
              </p>
          ...
          <div className="col-lg-6 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0">
            <div className="classic-saas-image position-relative">
              <div className=" position-relative">
                <Image
                  src={require("../../../../assets/images/home/hr_landing_page.svg")}
                  alt="Open"
                  className="img-fluid"
                />
              </div>
